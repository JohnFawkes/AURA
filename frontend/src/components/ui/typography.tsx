...
const H1 = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
	(props, ref) => (
		<h1
			{...props}
			ref={ref}
			className={cn("scroll-m-20 text-4xl font-bold lg:text-5xl mb-4", props.className)}
		>
			{props.children}
		</h1>
	)
...
const H4 = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
	(props, ref) => (
		<h4
			{...props}
			ref={ref}
			className={cn("scroll-m-20 text-xl font-medium tracking-wide mb-2", props.className)}
		>
			{props.children}
		</h4>
	)
