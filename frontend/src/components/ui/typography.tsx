...
const H2 = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>((props, ref) => (
	<h2 {...props} ref={ref} className={cn("scroll-m-20 text-3xl font-bold", props.className)}>
		{props.children}
	</h2>
));
H2.displayName = "H2";
...
const H3 = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>((props, ref) => (
	<h3 {...props} ref={ref} className={cn("scroll-m-20 text-2xl font-semibold", props.className)}>
		{props.children}
	</h3>
));
H3.displayName = "H3";
...
const H4 = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>((props, ref) => (
	<h4 {...props} ref={ref} className={cn("scroll-m-20 text-xl font-medium tracking-wide mb-2", props.className)}>
		{props.children}
	</h4>
));
H4.displayName = "H4";
...
const Lead = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>((props, ref) => (
	<p {...props} ref={ref} className={cn("text-lg text-primary leading-relaxed", props.className)}>
		{props.children}
	</p>
));
...
const P = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>((props, ref) => (
	<p
		{...props}
		ref={ref}
		className={cn("leading-7 text-base text-muted-foreground font-normal tracking-wide mb-4", props.className)}
	>
		{props.children}
	</p>
));
...
const Small = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>((props, ref) => (
	<p
		{...props}
		ref={ref}
		className={cn("text-sm font-medium leading-none text-muted-foreground mb-1", props.className)}
	>
		{props.children}
	</p>
));
...
const List = forwardRef<HTMLUListElement, React.HTMLAttributes<HTMLUListElement>>((props, ref) => (
	<ul {...props} ref={ref} className={cn("my-4 ml-6 list-disc space-y-1", props.className)}>
		{props.children}
	</ul>
));
...
const Quote = forwardRef<HTMLQuoteElement, React.HTMLAttributes<HTMLQuoteElement>>((props, ref) => (
	<blockquote
		{...props}
		ref={ref}
		className={cn("mt-6 border-l-4 pl-4 italic text-muted-foreground leading-relaxed", props.className)}
	>
		{props.children}
	</blockquote>
));
