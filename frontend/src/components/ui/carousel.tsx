...
function CarouselItem({ className, ...props }: React.ComponentProps<"div">) {
	...
	return (
		<div
			...
			className={cn(
				"min-w-0 shrink-0 grow-0 basis-1/2 sm:basis-1/2 md:basis-1/3 lg:basis-1/3 xl:basis-1/4 2xl:basis-1/5 3xl:basis-1/6 4xl:basis-1/8 5xl:basis-1/10 6xl:basis-1/12",
				orientation === "horizontal" ? "pl-2 py-2" : "pt-4",
				className
			)}
			{...props}
		/>
