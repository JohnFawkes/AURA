...
import type { ShowSet, MovieSet, CollectionSet } from "./sets";
...
export const FILE_TYPE_ERRORS: Record<FileUploadType, string> = {
  poster:
    "Only PNG, JPG, and WEBP files are allowed with 2:3 aspect ratio (1000x1500px - 2000x3000px)",
  backdrop:
  ...
  album:
    "Only PNG, JPG, and WEBP files are allowed with 1:1 aspect ratio (720x720px - 3000x3000px)",
