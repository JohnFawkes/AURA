...
func SendPushoverMessage(ctx context.Context, provider *config.Config_Notification_Pushover, message string, imageURL string, title string) logging.LogErrorInfo {
	...
	app := pushover.New(provider.ApiToken)
