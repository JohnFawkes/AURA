...
import { fetchMediaServerImageData } from "../../../frontend/src/services/api.mediaserver";

const imageCache = new Map<string, string>(); // Cache to store loaded image URLs

const MediaItemPosterImage: React.FC<{ ratingKey: string; alt: string }> = ({
	ratingKey,
	alt,
}) => {
...
export default MediaItemPosterImage;
